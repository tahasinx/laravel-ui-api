...
@section('content')
    <div class="form-content">
        <div class="form-items">
            ...
            <small>A <strong>6-digit</strong> verification code sent to
                <strong>{{ Session::get('reset_email') }}</strong></small>
            <div class="page-links mt-4">
                <a href="{{ route('auth.reset.password') }}" class="active"><i class="bi bi-shield-check"></i>
                    Reset Password
                </a>
                <a href="{{ route('auth.forgot.password') }}"><i class="bi bi-arrow-clockwise"></i>Try Again</a>
            </div>
            <form class="" autocomplete='off'
                action="javascript:reset_password('reset-password','{{ route('reset.password') }}','{{ route('get.new.csrf-token') }}')"
                id="reset-password">
                <div class="input-group mb-2 mr-sm-2 d-none">
                    ...
                    <input type="hidden" name="email" value="{{ Session::get('reset_email') }}" class="form-control flat"
                        placeholder="E-mail Address" required readonly>
                </div>
                <div class="input-group mb-2 mr-sm-2">
                    ...
                    <input type="text" name="verification_code" class="form-control flat" placeholder="Verification Code"
                        required>
                </div>
                <div class="input-group mb-2 mr-sm-2">
                    <div class="input-group-prepend flat">
                    ...
                    <input type="password" name="new_password" id="password" class="form-control flat"
                ...
                <div class="form-button" id="reset-btn">
                    <a href="{{ route('auth.sign.in') }}">Back to <strong class="text-primary">Sign-In</strong></a>
                    <button type="submit" class="ibtn flat" style="width: 100px">Reset</button>
                </div>

                <div class="form-button d-none" id="reset-processing">
                    <a href="{{ route('auth.sign.in') }}">Back to <strong class="text-primary">Sign-In</strong></a>
        ...
        <div class="form-sent">
            ...
            <p>Please return to the sign-in page & try the new password</p>
            <div class="info-holder">
                <span>Back to </span> <a href="{{ route('auth.sign.in') }}">Sign-In</a>.
            </div>
